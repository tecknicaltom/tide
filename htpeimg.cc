...
static UiView *htpeimage_init(Bounds *b, File *file, UiFormatGroup *group)
{
 ...
 *	CLASS ht_pe_aviewer
 */
void ht_pe_aviewer::init(Bounds *b, const char *desc, int caps, File *File, UiFormatGroup *format_group, Analyser *Analy, ht_pe_shared_data *PE_shared)
{
