...
static UiView *htxbeheader_init(Bounds *b, File *file, UiFormatGroup *group)
{
...
void ht_xbe_header_viewer::init(Bounds *b, const char *desc, int caps, File *file, UiFormatGroup *group)
{
