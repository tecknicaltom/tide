...
public:
	...
	virtual	int		compareDelinear(const Address *to) const;
	virtual	bool 		difference(int &result, const Address *to) const = 0;
...
public:
	...
	virtual	bool		difference(int &result, const Address *to) const;
