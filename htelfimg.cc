...
static UiView *htelfimage_init(Bounds *b, File *file, UiFormatGroup *group)
{
 ...
 */
void ht_elf_aviewer::init(Bounds *b, const char *desc, int caps, File *File, UiFormatGroup *format_group, Analyser *Analy, ht_elf_shared_data *ELF_shared)
{
